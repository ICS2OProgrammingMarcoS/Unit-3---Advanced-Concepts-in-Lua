...
local function DetermineAnswers()
    ...
    wrongAnswer3 = answer + math.random(10,15)
end
...
function scene:create( event )
    ...
    addEquationTextObject = display.newText( "", display.contentWidth*.9/4, display.contentHeight*2/5, nil, 55 )
    ...
    answerTextObject = display.newText("", display.contentWidth*.4, display.contentHeight/2, nil, 55 )
    wrongAnswer1TextObject = display.newText("", display.contentWidth*.3, display.contentHeight/2, nil, 55 )
    wrongAnswer2TextObject = display.newText("", display.contentWidth*.2, display.contentHeight/2, nil, 55 )
    wrongAnswer3TextObject = display.newText("", display.contentWidth*.1, display.contentHeight/2, nil, 55 )
